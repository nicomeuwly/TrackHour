        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12">
            ...
            <article className="prose prose-neutral sm:max-w-3/4 space-y-10">
                <section>
                    ...
                    <p className="text-text/70 leading-relaxed">{t('whyMattersText')}</p>
                </section>
                ...
                <section>
                    ...
                    <p className="text-text/70 leading-relaxed">{t('overtimeText')}</p>
                </section>
                ...
                <section>
                    ...
                    <p className="text-text/70 leading-relaxed">{t('remoteText')}</p>
                </section>

                <section>
                    <h2 className="text-2xl font-bold mb-4">{t('mistakesTitle')}</h2>
                    <p className="text-text/70 leading-relaxed">{t('mistakesText')}</p>
                </section>
